    ...
    <section className="bg-neutral-50">
      <div className="pt-14 md:pt-16">
        <div className="mx-auto flex max-w-4xl flex-col items-center justify-center">
          <h1 className="text-center text-[22px] font-bold md:text-[28px]">
            Find your car
          </h1>
          <div className="pt-8">
            <div className="flex flex-col gap-4 gap-x-3 gap-y-4 sm:grid sm:grid-cols-2 sm:grid-rows-2 md:flex md:flex-row md:items-center md:justify-center md:gap-x-9">
